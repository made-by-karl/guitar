import { HarmonicFunctionsService, Degree, HarmonicFunction } from '@/app/features/grips/services/chords/harmonic-functions.service';
import { Semitone, SEMITONES } from '@/app/core/music/semitones';
